...
if dataset == "csn" or dataset == "csn-ambig" or dataset == "reactions" or dataset == "explorations" or dataset == "interpretations":
  num_labels = 3
  size = 40
...
if dataset == "yelp" or dataset == "csn" or dataset == "csn-ambig" or dataset == "reactions" or dataset == "explorations" or dataset == "interpretations" or dataset == "MELD" :
  text_idx = 1
...
for line in test_data_np:
  text = line[text_idx]
  if type(text) == float or type(text) == int or (len(text.split()) < 10):
    continue
  text = text.strip()
  text = text.replace("\n"," ")
  text += "\n"
